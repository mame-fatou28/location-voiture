            ...
            <div className="flex flex-col lg:flex-row gap-10 mt-20">
                ...
                >
                    ...
                    <div className="flex flex-col gap-1.5 ml-0 md:ml-10 mt-3">
                        ...
                        <select className="bg-zinc-900 border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-red-600 text-white text-sm w-80">
                    ...
                    <div className="flex flex-col gap-1.5 ml-0 md:ml-10 mt-3">
                        ...
                        <select className="bg-zinc-900 border border-white/10 focus:outline-none focus:border-red-600 rounded-xl px-4 py-3 text-white text-sm w-80">
                    ...
                    <div className='flex flex-col md:col-span-2'>
                        ...
                        <input type="date"
                            className="bg-zinc-900 border ml-0 md:ml-8 mt-3 focus:outline-none focus:border-red-600 border-white/10 rounded-xl px-4 py-3 text-white text-sm w-180" />
                    </div>
                    ...
                    <motion.button
                        ...
                        className='w-full md:w-60 h-12 bg-red-600 text-white mt-6 md:mt-10 rounded-lg'
                    >
                        Envoyer le message
                    </motion.button>
